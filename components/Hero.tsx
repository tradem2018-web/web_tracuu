        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <a 
              ...
              className="flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-full text-white bg-primary hover:bg-sky-700 md:py-4 md:text-lg md:px-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-full text-white bg-gray-800 hover:bg-gray-900 md:py-4 md:text-lg md:px-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
            >
              <Download className="w-5 h-5 mr-2" />
              App Store
            </a>
            <Link 
              to="/intro"
              className="flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-8 shadow-sm transition-all"
            >
              {content.learnMore}
